...
Shows °F (e.g. `78.3`) and humidity (e.g. `H38`), one sensor read every 6 seconds (3 s per value on the display). Optional photoresistor dimming on **P3 pin 2**; compile-time calibration offsets for temperature and humidity.
